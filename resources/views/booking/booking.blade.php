                ...
                <div class="card-body">
                                        ...
                                        @foreach ($bookings as $booking)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <form action="{{ route('booking.destroy', $booking->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Apakah kamu yakin ingin menghapus data ini?');">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @else
                            <h6 class="heading-small text-muted mb-4" >Riwayat Booking</h6>
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            <th>No.</th>
